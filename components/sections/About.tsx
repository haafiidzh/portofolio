...
const FACTS = [
  ["Based in", "Jakarta, Indonesia — working GMT+7, overlapping EU mornings."],
  ["Working style", "Small scope, short feedback loops, no surprise rewrites."],
  ["Currently", "Open to one more fractional CTO retainer for 2026."],
];
  ...
  return (
    <section id="about" className="px-6 py-28 md:px-10 md:py-40">
      <div className="mx-auto max-w-7xl">
        <SectionHeader index="01" eyebrow="About" title="Engineering as a calm, deliberate practice." />
